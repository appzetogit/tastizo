...
export const authAPI = {
  ...
  loginWithGoogle: (idToken, fcmToken = null, platform = "web") =>
    authService.loginUserWithGoogle(idToken, fcmToken, platform),
...
export const restaurantAPI = {
  ...
  logoutAllDevices: () => {
    ...
    restaurantCurrentCacheTime = 0;
    const fcmToken = typeof localStorage !== "undefined" ? localStorage.getItem("fcm_web_registered_token_restaurant") : null;
    return authService.logoutAllDevices(fcmToken, "web");
  },
...
export const userAPI = {
  ...
  getLocation: () =>
    apiClient.get("/food/user/location", {
      contextModule: "user",
    }),
  /** PUT /food/user/location (Bearer USER) */
  updateLocation: (body) =>
    apiClient.put("/food/user/location", body ?? {}, {
      contextModule: "user",
    }),
  ...
  /** PUT /food/user/addresses/:id (Bearer USER) */
  updateAddress: (id, body) =>
    apiClient.put(`/food/user/addresses/${String(id)}`, body ?? {}, {
      contextModule: "user",
    }),
