       ...
       {loading ? (
          ...
          <>
               ...
               <div className="bg-yellow-400 p-4 flex items-start gap-3 border-b border-yellow-500/10">
                  ...
                  <div>
                     ...
                     <p className="text-[10px] font-medium opacity-80 leading-tight mt-1">
                        {walletState.withdrawableAmount <= 0 ? 'Withdrawable amount is \u20B90' : `Minimum withdrawal requirement is ${formatCurrency(walletState.withdrawalLimit, "\u20B9").replace("\u20B9 ", "\u20B9")}`}
                     </p>
                  </div>
               </div>
             )}
             ...
             <div className="bg-white p-8 mb-4 text-center border-b border-gray-100 shadow-sm">
                ...
                <h2 className="text-5xl font-black text-black mb-6 tracking-tighter">{formatCurrency(walletState.withdrawableAmount, "\u20B9").replace(".00", "").replace("\u20B9 ", "\u20B9")}</h2>
