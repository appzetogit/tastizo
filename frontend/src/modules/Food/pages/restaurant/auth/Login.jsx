...
export default function RestaurantLogin() {
  ...
  return (
    ...
    >
      ...
      <div className="md:hidden mx-auto flex min-h-screen w-full sm:max-w-[400px] flex-col overflow-hidden bg-white">
          ...
          <div>
            ...
            <div className="bg-white pt-10 pb-4">
              ...
              <form onSubmit={handleSubmit} className="mt-6 space-y-3.5 px-4 sm:px-5">
                ...
                <Button
                  type="submit"
                  className="mt-4 h-14 w-full rounded-2xl bg-[#2a9c64] text-lg font-bold text-white transition-all hover:bg-[#238653] active:scale-[0.99]"
                  disabled={isLoading}
                >
                  {isLoading ? (
                    <>
