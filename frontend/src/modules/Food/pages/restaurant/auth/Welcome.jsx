...
export default function RestaurantWelcome() {
  ...
  const companyName = useCompanyName() || "Tastizo"
  ...
  return (
    <div className="h-screen w-full flex flex-col bg-black overflow-hidden">
      ...
      >
        ...
        <Button
          onClick={handleLogin}
          className="w-full bg-[#2A9C64] hover:bg-[#6a2f56] text-white font-bold py-6 md:py-7 text-base md:text-lg rounded-lg transition-colors shadow-lg"
        >
          Login
        </Button>
        ...
        {/* <Button
          ...
          variant="outline"
          className="w-full border-2 border-[#2A9C64] text-[#2A9C64] hover:bg-[#2A9C64] hover:text-white font-bold py-6 md:py-7 text-base md:text-lg rounded-lg transition-all shadow-lg bg-transparent"
        >
