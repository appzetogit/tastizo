        ...
        >
          ...
          <div className="border-t border-gray-200 px-4 py-4 flex justify-center">
            <button
              ...
              className="text-[#2A9C64] hover:text-[#6a2f56] font-bold text-base transition-colors"
            >
              Okay
            </button>
          </div>
    ...
    >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`p-2 transition-all duration-200 rounded-full ${profileOpen ? "bg-[#2A9C64] text-white shadow-lg" : "bg-gray-100 hover:bg-gray-200 text-gray-900"}`}
              aria-label="Profile"
            >
      ...
      <div className="px-4 py-6">
        ...
        <motion.button
          ...
          className="w-full flex items-center justify-between gap-3 rounded-2xl border border-[#2A9C64]/20 bg-[#2A9C64]/5 px-4 py-4 text-left hover:bg-[#2A9C64]/10 transition-all active:scale-[0.99]"
        >
          ...
          <>
            ...
            >
              <div className="text-center">
                <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-[#2A9C64]/10">
                  <LogOut className="w-5 h-5 text-[#2A9C64]" />
                </div>
              ...
              <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-200">
                ...
                <div className="flex-1 relative">
                  <input
                    ...
                    autoFocus
                    className="w-full px-4 py-2 pr-10 bg-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2A9C64] text-gray-900 placeholder-gray-500"
                  />
                  {searchQuery && (
                    <button
          ...
          <>
            ...
            >
              ...
              <div className="px-6 py-6">
                ...
                >
                  {/* Avatar */}
                  <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center shrink-0 overflow-hidden ring-4 ring-[#2A9C64]/10 group-hover:ring-[#2A9C64]/20 transition-all">
                    {userData.profileImage?.url ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-[#2A9C64]/5 to-[#2A9C64]/20">
                        <User className="w-8 h-8 text-[#2A9C64]" />
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] font-bold text-[#2A9C64] uppercase tracking-widest mt-2 bg-[#2A9C64]/5 w-fit px-2.5 py-1 rounded-full border border-[#2A9C64]/10">
                      {userData.role}
                    </p>
                  </div>
                </button>
              ...
              <div className="px-6 pb-6 space-y-3">
                ...
                <button
                  ...
                  disabled={isLoggingOut}
                  className="w-full bg-[#2A9C64]/10 text-[#2A9C64] border border-[#2A9C64]/20 hover:bg-[#2A9C64]/20 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed font-bold py-4 px-4 rounded-2xl transition-all flex items-center justify-center gap-2"
                >
                  <LogOut className="w-5 h-5 text-[#2A9C64]" />
            ...
            >
              ...
              <div className="px-6 py-6 space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-[#2A9C64] hover:bg-[#6a2f56] text-white font-bold py-3.5 px-4 rounded-xl transition-all shadow-md active:scale-[0.98] mt-4"
                >
                  Submit
                </button>
              </div>
            ...
            >
              <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full p-6 text-center">
                ...
                <button
                  ...
                  className="w-full bg-[#2A9C64] text-white py-3.5 rounded-xl font-bold text-sm hover:bg-[#6a2f56] transition-all shadow-md active:scale-[0.98]"
                >
                  Done 
                </button>
              </div>
