...
const ActionButton = ({ icon: Icon, label, onClick }) => (
  <button 
    onClick={onClick}
    className="w-full flex items-center justify-between p-4 bg-white rounded-2xl border border-gray-100 hover:border-[#2A9C64]/30 hover:bg-[#2A9C64]/5 transition-all active:scale-[0.98] shadow-sm"
  >
    <div className="flex items-center gap-4">
      <div className="bg-[#2A9C64]/5 p-2.5 rounded-xl">
        <Icon className="w-5 h-5 text-[#2A9C64]" />
      </div>
        ...
        <div className="bg-white/80 backdrop-blur-md border-b border-gray-100 px-4 py-3 sticky top-0 z-50 shadow-sm">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 flex-1">
              <button 
                onClick={goBack} 
                className="p-2 hover:bg-[#2A9C64]/5 rounded-xl transition-all active:scale-95"
              >
                <ArrowLeft className="w-5 h-5 text-[#2A9C64]" />
              </button>
              <h1 className="text-[17px] font-bold text-gray-900 tracking-tight">Outlet Information</h1>
            </div>
            <div className="bg-[#2A9C64]/5 px-3 py-1.5 rounded-full border border-[#2A9C64]/10">
              <p className="text-[11px] font-bold text-[#2A9C64] uppercase tracking-wider">
            ...
            <div className="relative group">
              <div className="w-24 h-24 rounded-[2rem] bg-white p-1.5 shadow-2xl ring-1 ring-black/5">
                ...
                <button
                  ...
                  disabled={uploadingImage}
                  className="absolute -bottom-1 -right-1 bg-[#2A9C64] p-2 rounded-xl text-white shadow-lg shadow-[#2A9C64]/30 hover:scale-105 transition-all border-2 border-white active:scale-90"
                >
          ...
          <div className="space-y-4">
            ...
            >
              <div className="absolute top-0 right-0 p-2 opacity-20 group-hover:opacity-100 transition-opacity">
                <div className="bg-[#2A9C64] p-1.5 rounded-lg">
                  <Edit className="w-3 h-3 text-white" />
                </div>
              </div>
              <p className="text-[10px] text-[#2A9C64] font-black uppercase tracking-widest mb-1.5 flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 bg-[#2A9C64] rounded-full"></span>
                Official Name
              </p>
              <p className="text-lg font-black text-gray-900 group-hover:text-[#2A9C64] transition-colors">
            ...
            >
              ...
              <div className="flex items-start gap-3">
                <div className="bg-white p-2 rounded-xl shadow-sm border border-gray-100 shrink-0">
                  <MapPin className="w-5 h-5 text-[#2A9C64]" />
                </div>
      ...
      <Dialog open={showEditNameDialog} onOpenChange={setShowEditNameDialog}>
        <DialogContent className="sm:max-w-md p-0 overflow-hidden rounded-[2.5rem] w-[92%] border-none shadow-2xl">
          ...
          <div className="p-6 space-y-4">
            <div className="relative group">
              <Input 
                ...
                placeholder="Ex: Tastizo Express" 
                className="w-full h-14 px-5 rounded-2xl border-2 border-gray-100 focus:border-[#2A9C64] focus:ring-0 transition-all font-bold text-lg bg-gray-50 group-hover:bg-white" 
              />
              <Pencil className="absolute right-5 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-300 group-hover:text-[#2A9C64] transition-colors" />
            </div>
          ...
          <DialogFooter className="p-6 bg-gray-50/50 flex flex-row gap-3">
            ...
            <Button onClick={handleSaveName} disabled={!editNameValue.trim()} className="flex-[2] h-12 bg-[#2A9C64] text-white hover:bg-[#6a2f56] rounded-2xl font-bold shadow-lg shadow-[#2A9C64]/20 transition-all active:scale-95 disabled:opacity-50">Save Changes</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
