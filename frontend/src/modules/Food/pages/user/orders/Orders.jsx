    ...
    return (
      <div className="min-h-screen bg-gray-50 pb-10">
        ...
        <div className="flex items-center justify-center py-20">
          <Loader2 className="w-8 h-8 text-[#2A9C64] animate-spin" />
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 pb-10">
        ...
        <div className="px-4 py-8 text-center">
          ...
          <Link to="/user">
            <button className="mt-4 text-[#2A9C64] font-medium">Start Ordering</button>
          </Link>
        </div>
      </div>
    )
    ...
    <div className="min-h-screen bg-gray-50 pb-10 font-sans">
      ...
      <div className="p-4 bg-white mt-1">
        <div className="flex items-center bg-white border border-gray-200 rounded-lg px-3 py-2 shadow-sm">
          <Search className="w-5 h-5 text-[#2A9C64]" />
          <input
            type="text"
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {order.restaurantId && (
                        <Link to={`/user/restaurants/${order.restaurantId}`}>
                          <button className="text-xs text-[#2A9C64] font-medium flex items-center mt-1 hover:text-[#1E7A4A]">
                ...
                <div className="px-4 py-2 flex items-center justify-between">
                  ...
                  <div className="flex items-center ml-4">
                    <Link to={(isDelivered || isCancelled) ? `/user/orders/${order.id}/details` : `/user/orders/${order.id}`}>
                      <button className="text-xs text-[#2A9C64] font-medium hover:text-[#1E7A4A] flex items-center gap-1">
                        View Details
                ...
                <div className="px-4 py-3 flex items-center justify-between">
                  ...
                  {isRestaurantCancelled ? (
                    ...
                    <div>
                      ...
                      {countdowns[order.id] && countdowns[order.id] > 0 && (
                        <div className="flex items-center gap-1 mt-1 text-xs text-[#2A9C64] font-medium">
                          <Clock size={12} />
                  ...
                  {isDelivered && !paymentFailed && (
                    <button
                      ...
                      className="bg-[#2A9C64] hover:bg-[#1E7A4A] text-white px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-1 shadow-sm transition-colors"
                    >
            ...
            <div className="px-6 py-6">
              <div className="mb-6">
                ...
                <textarea
                  ...
                  className="w-full rounded-xl border-2 border-gray-200 px-4 py-2 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#2A9C64] focus:border-[#2A9C64] resize-none transition-all"
              ...
              <button
                ...
                className="w-full rounded-xl bg-gradient-to-r from-[#2A9C64] to-[#1E7A4A] text-white text-base font-bold py-3.5 hover:from-[#1E7A4A] hover:to-[#C44409] disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-[#2A9C64]/30 flex items-center justify-center gap-2"
              >
                {submittingRating ? (
                  <>
            ...
            <div className="px-5 py-5 space-y-3">
              {typeof navigator !== "undefined" && navigator.share && (
                <button
                  ...
                  className="w-full rounded-2xl bg-[#2A9C64] px-4 py-3 text-sm font-semibold text-white flex items-center justify-center gap-2 hover:bg-[#1E7A4A] transition-colors"
                >
