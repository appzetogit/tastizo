  ...
  const goBack = useAppBackNavigation()
    ...
    return (
        <AnimatedPage className="bg-slate-50 dark:bg-slate-950 min-h-screen pb-24 transition-colors">
            {/* Header */}
            <div className="bg-[#2A9C64] text-white px-4 py-4 sticky top-0 z-50 shadow-md">
            ...
            <div className="p-4 space-y-4">
                    ...
                    <div className="p-4 space-y-4">
                        <div className="flex items-start gap-3">
                            <div className="bg-[#F9F9FB] dark:bg-slate-800 p-2 rounded-xl">
                                <Calendar className="w-5 h-5 text-[#2A9C64]" />
                            </div>
                             <div>
                ...
                >
                    <div className="flex items-center gap-3">
                        <div className={`p-2 rounded-xl transition-colors ${specialRequest ? 'bg-purple-50 dark:bg-purple-950/30' : 'bg-slate-100 dark:bg-slate-800 group-hover:bg-slate-200 dark:group-hover:bg-slate-700'}`}>
                            <Info className={`w-5 h-5 ${specialRequest ? 'text-[#2A9C64]' : 'text-slate-600 dark:text-slate-400'}`} />
                        </div>
                    ...
                    <div className="flex items-center gap-2">
                        {specialRequest && (
                            <span className="text-[10px] font-black text-[#2A9C64]/40 uppercase tracking-widest">Edit</span>
                        )}
                ...
                <div className="pt-4">
                    ...
                    <div className="space-y-2">
                        ...
                        >
                            <div className="flex items-start gap-3">
                                <div className="text-[#2A9C64] dark:text-purple-400 mt-1">
                    ...
                    <div className="relative w-full max-w-lg bg-white rounded-t-3xl sm:rounded-2xl shadow-2xl p-6 overflow-hidden animate-in slide-in-from-bottom duration-300">
                        ...
                        <div className="space-y-4">
                            ...
                            <textarea
                                ...
                                className="w-full h-32 p-4 rounded-2xl bg-slate-50 border border-slate-100 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#2A9C64]/20 focus:border-[#2A9C64] transition-all resize-none"
                                autoFocus
                            />
                            ...
                            <div className="grid grid-cols-2 gap-3 pt-2">
                                ...
                                <button 
                                    ...
                                    className="h-12 rounded-xl bg-[#2A9C64] text-white font-bold text-sm uppercase tracking-widest shadow-lg shadow-purple-200 active:scale-95 transition-all"
                                >
                                    Save
                                </button>
                            </div>
