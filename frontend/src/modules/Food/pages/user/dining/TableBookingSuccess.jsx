        ...
        <AnimatedPage className="bg-white dark:bg-slate-950 min-h-screen flex flex-col items-center justify-center p-6 pb-24 transition-colors">
            ...
            >
                {booking.status === 'pending' ? (
                    ...
                    <CheckCircle2 className="w-12 h-12 text-[#2A9C64]" />
                )}
            </motion.div>
            ...
            >
                ...
                <div className="pt-2">
                    <span className="bg-[#F9F9FB] dark:bg-slate-900 text-[#2A9C64] dark:text-purple-400 px-4 py-1 rounded-full text-xs font-bold uppercase tracking-widest border border-[#2A9C64]/20 dark:border-purple-400/20">
