                                ...
                                {quantity > 0 ? (
                                  <Link to="/user/cart" onClick={(e) => e.stopPropagation()}>
                                    <Button
                                      variant={"ghost"}
                                      size="sm"
                                      className="bg-[#2A9C64] text-white hover:bg-[#1E7A4A] h-7 md:h-8 lg:h-9 px-3 md:px-4 lg:px-5 text-xs md:text-sm lg:text-base font-bold shadow-md transition-all active:scale-95"
                                    >
                                      View cart
                                    </Button>
                                  </Link>
            ...
            >
              ...
              <div className="flex items-center justify-between px-4 md:px-6 py-4 md:py-5 border-b dark:border-gray-800">
                ...
                <button
                  ...
                  className="text-[#2A9C64] dark:text-[#8AB69D] font-medium text-sm md:text-base"
                >
                  Clear all
                </button>
              </div>
                  ...
                  {sortOptions.map((option) => (
                    <button
                      ...
                      className={`px-4 md:px-5 lg:px-6 py-3 md:py-4 rounded-xl border text-left transition-colors ${draftSelectedSort === option.id
                        ? 'border-[#2A9C64] bg-[#f2faf6] dark:bg-[#2A9C64]/20'
                        : 'border-gray-200 dark:border-gray-800 hover:border-[#2A9C64]'
                        }`}
                    >
                      <span className={`text-sm md:text-base lg:text-lg font-medium ${draftSelectedSort === option.id ? 'text-[#2A9C64] dark:text-[#8AB69D]' : 'text-gray-700 dark:text-gray-300'}`}>
                        {option.label}
                      </span>
                    </button>
                  ))}
              ...
              <div className="flex items-center gap-4 md:gap-6 px-4 md:px-6 py-4 md:py-5 border-t dark:border-gray-800 bg-white dark:bg-[#1a1a1a]">
                ...
                <button
                  onClick={handleApply}
                  className="flex-1 py-3 md:py-4 font-semibold rounded-xl transition-colors text-sm md:text-base bg-[#2A9C64] text-white hover:bg-[#1E7A4A]"
                >
                  Apply
                </button>
              </div>
                ...
                {selectedItem.customisable && (
                  <div className="flex items-center gap-2 mb-4">
                    <div className="flex-1 h-0.5 bg-gray-200 rounded-full overflow-hidden">
                      <div className="h-full bg-[#2A9C64]" style={{ width: '50%' }} />
                    </div>
                ...
                <div className="flex items-center gap-4 md:gap-5 lg:gap-6">
                  ...
                  <Button
                    className={`flex-1 h-[44px] md:h-[50px] lg:h-[56px] rounded-lg md:rounded-xl font-semibold flex items-center justify-center gap-2 text-sm md:text-base lg:text-lg ${shouldShowGrayscale
                      ...
                      : 'bg-[#2A9C64] hover:bg-[#1E7A4A] dark:bg-[#2A9C64] dark:hover:bg-[#1E7A4A] text-white'
                      }`}
                    onClick={(e) => {
                      if (!shouldShowGrayscale) {
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <button
                    ...
                    className="rounded-2xl border border-gray-200 dark:border-gray-700 px-4 py-3 text-sm font-medium text-gray-800 dark:text-gray-200 hover:border-[#2A9C64] hover:text-[#2A9C64] transition-colors"
                  >
                    {option.label}
                  </button>
                ))}
