...
const gradientColors = [
  ...
  "bg-gradient-to-br from-orange-400 to-#1E7A4A",
  "bg-gradient-to-br from-purple-500 to-pink-600",
  "bg-gradient-to-br from-green-400 to-emerald-600",
  "bg-gradient-to-br from-orange-400 to-red-500",
  "bg-gradient-to-br from-amber-400 to-yellow-600",
  "bg-gradient-to-br from-pink-400 to-rose-600",
  "bg-gradient-to-br from-amber-400 to-#1E7A4A",
]
      ...
      <div className="px-4 sm:px-6 md:px-8 lg:px-10 py-6 md:py-8 lg:py-10">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-5 lg:gap-6">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center pb-10">
                    <div className="relative w-32 h-24">
                      ...
                      <div className="absolute right-0 top-0 w-14 h-11 bg-white rounded-lg shadow-lg transform rotate-12 overflow-hidden">
                        <div className="w-full h-full bg-gray-50 flex items-center justify-center p-1">
                          <Store className="h-6 w-6 text-[#2A9C64]" />
                        </div>
                        {/* Striped awning */}
            ...
            >
              <div className="w-12 h-12 rounded-full bg-[#F9F9FB] dark:bg-[#2A9C64]/20 flex items-center justify-center border-2 border-[#2A9C64]/30 dark:border-[#2A9C64]/40">
                <Plus className="h-6 w-6 text-[#2A9C64] dark:text-[#2A9C64]" />
              </div>
          ...
          <div className="relative bg-white dark:bg-[#1a1a1a] rounded-2xl shadow-2xl w-[90%] max-w-sm mx-4 overflow-hidden animate-[slideUp_0.3s_ease-out]">
            ...
            <div className="p-4 space-y-4">
              ...
              <Input
                ...
                className="w-full h-12 text-base border-2 border-gray-200 dark:border-gray-700 focus:border-[#2A9C64] dark:focus:border-[#2A9C64] rounded-xl bg-white dark:bg-[#2a2a2a] text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400"
                autoFocus
              />
            ...
            <div className="flex gap-3 p-4 bg-gray-50 dark:bg-gray-800">
              ...
              <Button
                ...
                className="flex-1 h-11 bg-[#2A9C64] hover:bg-[#1E7A4A] text-white rounded-xl font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Create Collection
              </Button>
            </div>
