...
export default function Checkout() {
  ...
  const { selectSavedAddress } = useLocation()
                  ...
                  {addresses.length > 0 ? (
                    <div className="space-y-3">
                      {addresses.map((address) => {
                        ...
                        const addressString = formatAddressLine(address)
                        ...
                        return (
                          <div
                            ...
                            onClick={() => {
                              ...
                              if (addressId) selectSavedAddress(addressId)
                            }}
                          >
                    ...
                    <div className="text-center py-8">
                      ...
                      <Button
                        onClick={() =>
                          navigate("/user/address-selector", { state: { from: "/user/cart/checkout" } })
                        }
                      >
                        Add Address
                      </Button>
