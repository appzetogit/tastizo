...
export default function PageNavbar({
  ...
  const textColorClass = textColor === "white" ? "text-white" : "text-[#2A9C64]"
  const iconFill = textColor === "white" ? "white" : "#2A9C64"
  const ringColor = textColor === "white" ? "ring-white/30" : "ring-[#2A9C64]/30"
      ...
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0 ml-auto">
          <Link to="/user/wallet">
            ...
            >
              <div className={`h-full w-full rounded-full bg-transparent flex items-center justify-center shadow-md border border-gray-100/50 dark:border-white/10`}>
                <Wallet className={`h-4.5 w-4.5 sm:h-5.5 sm:w-5.5 ${textColor === "white" ? "text-white" : "text-[#2A9C64] dark:text-[#a14b84]"}`} strokeWidth={3} />
              </div>
            </Button>
          </Link>
          ...
          <Link to="/user/cart">
            ...
            >
              <div className={`h-full w-full rounded-full bg-transparent flex items-center justify-center shadow-md border border-gray-100/50 dark:border-white/10`}>
                <ShoppingCart className={`h-4.5 w-4.5 sm:h-5.5 sm:w-5.5 ${textColor === "white" ? "text-white" : "text-[#2A9C64] dark:text-[#a14b84]"}`} strokeWidth={3} />
              </div>
              {cartCount > 0 && (
                <span className="absolute -top-1 -right-1 w-4.5 h-4.5 bg-[#2A9C64] rounded-full flex items-center justify-center ring-2 ring-white">
          ...
          {showProfile && (
            <Link to="/user/profile">
              ...
              >
                <div className={`h-full w-full rounded-full bg-transparent flex items-center justify-center shadow-md border border-gray-100/50 dark:border-white/10`}>
                  <span className={`text-sm sm:text-base font-black ${textColor === "white" ? "text-white" : "text-[#2A9C64] dark:text-[#a14b84]"}`}>
                    A
                  </span>
                </div>
              </Button>
