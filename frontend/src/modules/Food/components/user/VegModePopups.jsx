          ...
          {showSwitchOffPopup && (
            <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
              ...
              <motion.div
                ...
                animate={{ scale: 1, opacity: 1, y: 0 }}
                exit={{ scale: 0.9, opacity: 0, y: 20 }}
                className="relative bg-white dark:bg-[#1a1a1a] rounded-3xl p-6 sm:p-8 max-w-sm w-full shadow-2xl overflow-hidden border border-[#2A9C64]/10 dark:border-[#2A9C64]/30"
              >
                <div className="absolute -top-10 -right-10 w-32 h-32 bg-[#2A9C64]/10 rounded-full blur-3xl" />

                <div className="relative text-center">
                  <div className="w-20 h-20 bg-[#2A9C64]/5 dark:bg-[#2A9C64]/20 rounded-full flex items-center justify-center mx-auto mb-6 ring-8 ring-[#2A9C64]/5 dark:ring-[#2A9C64]/5">
                    <AlertCircle className="w-10 h-10 text-[#2A9C64] dark:text-[#8AB69D]" />
                  </div>
                  ...
                  <div className="flex flex-col gap-3">
                    <button
                      ...
                      className="w-full py-4 bg-[#2A9C64] hover:bg-[#1E7A4A] text-white font-bold rounded-2xl shadow-lg shadow-[#2A9C64]/25 transition-all duration-300 transform active:scale-95 flex items-center justify-center gap-2"
                    >
