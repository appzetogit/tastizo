...
const CookingAnimation = memo(() => (
  <div className="relative w-12 h-12 flex items-center justify-center rounded-xl bg-orange-50 border border-orange-100 overflow-visible shadow-[0_4px_15px_rgba(235,89,14,0.15)] shrink-0">
    ...
    <motion.div animate={{ rotate: [-2, 2, -2] }} transition={{ duration: 0.6, repeat: Infinity, ease: "easeInOut" }} className="relative z-10 mt-1">
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#2A9C64] drop-shadow-sm">
        {/* Cooker Body */}
    ...
    <motion.div animate={{ opacity: [0.4, 0.8, 0.4], scaleX: [0.8, 1.2, 0.8] }} transition={{ duration: 0.6, repeat: Infinity, ease: "easeInOut" }} className="absolute bottom-0 w-full flex justify-center z-0">
      <div className="w-4 h-1 bg-[#2A9C64] blur-[2px] rounded-full" />
    </motion.div>
  </div>
));
      ...
      >
        ...
        >
          ...
          <button 
             ...
             className="absolute top-2 right-2 p-1.5 rounded-full bg-orange-50/80 text-orange-400 hover:text-#1E7A4A hover:bg-orange-100/80 transition-colors z-20 shadow-sm"
          >
          ...
          <div className="flex items-center gap-4 relative z-10 w-full">
            ...
            <div className="flex-1 min-w-0 pr-4">
              ...
              <div className="flex items-center gap-1.5 mt-0.5">
                ...
                <ChevronRight className="w-3.5 h-3.5 text-[#2A9C64] shrink-0 group-hover:translate-x-1 transition-transform" />
              </div>
            </div>

            <div className="bg-gradient-to-br from-[#2A9C64] to-[#D94E0A] shadow-lg shadow-[#2A9C64]/20 rounded-xl px-4 py-2 shrink-0 flex flex-col items-center justify-center border border-orange-200">
