    ...
    <div className="w-full bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between relative">
      ...
      {newReservation && (
        <div className="fixed top-20 left-4 right-4 z-[100] animate-in slide-in-from-top duration-300">
          <div className="bg-white rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.15)] border border-[#2A9C64]/10 overflow-hidden">
            <div className="p-4 flex items-center gap-4">
              <div className="w-12 h-12 rounded-2xl bg-purple-50 flex items-center justify-center shrink-0">
                <Utensils className="w-6 h-6 text-[#2A9C64]" />
              </div>
            ...
            <div className="bg-slate-50 p-3 flex gap-2">
              <button 
                ...
                className="flex-1 h-10 bg-[#2A9C64] text-white text-xs font-bold rounded-xl uppercase tracking-widest shadow-lg shadow-purple-200"
              >
                View Request
              </button>
              <button 
