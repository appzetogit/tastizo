      ...
      <div className="flex items-center justify-around py-2 px-4">
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2 transition-colors ${
            isActive("/food/restaurant") ? "text-[#2A9C64]" : "text-gray-600"
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2 transition-colors ${
            isActive("/food/restaurant/orders") ? "text-[#2A9C64]" : "text-gray-600"
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2 transition-colors ${
            isActive("/food/restaurant/wallet") ? "text-[#2A9C64]" : "text-gray-600"
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2 transition-colors ${
            isActive("/food/restaurant/food/all") ? "text-[#2A9C64]" : "text-gray-600"
          }`}
        >
