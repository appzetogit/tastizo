...
import deliveryNotificationRoutes from './routes/deliveryNotificationRoutes.js';
...
// Delivery notification routes (protected)
router.use('/', deliveryNotificationRoutes);
