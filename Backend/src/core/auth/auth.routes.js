...
import {
    ...
    googleUserLoginController,
    appleUserLoginCallbackController,
...
router.post('/user/google/login', authRateLimiter, googleUserLoginController);
router.get('/user/apple/callback', appleUserLoginCallbackController);
router.post('/user/apple/callback', appleUserLoginCallbackController);
router.get('/apple/callback', appleUserLoginCallbackController);
router.post('/apple/callback', appleUserLoginCallbackController);
